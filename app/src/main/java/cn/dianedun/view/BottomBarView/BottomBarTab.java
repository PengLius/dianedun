package cn.dianedun.view.BottomBarView;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_unselect));
        ...
        if (!TextUtils.isEmpty(title)){
            ...
            mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.grayfont_4));
...
//    };
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            if (mTvTitle!=null)
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.grayfont_4));
