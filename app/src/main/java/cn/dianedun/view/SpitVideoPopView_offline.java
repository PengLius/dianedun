 ...
 * <p>
 */
public class SpitVideoPopView_offline extends PopupWindow {
...
//                mRlLoadingLayout.setVisibility(View.GONE);
//                if (!SpitVideoPopView_offline.this.isShowing()) {
//                    return;
//                }
//
...
//    }
    ...
    public interface OnVideoSelect {
        ...
        void onVideoSelectFaild(int errorCode, String errorMsg);
    }
