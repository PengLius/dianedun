...
// */
//
//public class _PlayerBackActiviaty extends BaseActivity implements EZUIPlayer.EZUIPlayerCallBack ,
...
//        Intent intent = new Intent(context, _PlayerBackActiviaty.class);
...
//
//        if (mIsRecording) {
//            AlertDialog.Builder builder = new AlertDialog.Builder(_PlayerBackActiviaty.this);
//            builder.setTitle("提示");
...
//                if(e.getCode() == 2001)
//                    startActivity(new Intent(_PlayerBackActiviaty.this, LoginActivity.class));
...
////                        new String[]{"高清","标清","流畅"},
////                        _PlayerBackActiviaty.this, AlertView.Style.ActionSheet, new OnItemClickListener() {
////                    @Override
...
//                        public void onClick(DialogInterface dialog, int which) {
//                            stopRealPlayRecord();
//                            new DateTimeDialogOnlyYMD(_PlayerBackActiviaty.this,mCurCalendar, new DateTimeDialogOnlyYMD.MyOnDateSetListener() {
//                                @Override
...
//                                }
//                            },true,true,true).show();
////                            new DatePickerDialog(_PlayerBackActiviaty.this, new DatePickerDialog.OnDateSetListener() {
////                                @Override
...
////                    },mCurCalendar.get(Calendar.YEAR),mCurCalendar.get(Calendar.MONTH),mCurCalendar.get(Calendar.DAY_OF_MONTH)).show();
//                }
////                DateTimeDialog dateTimeDialog = new DateTimeDialog(_PlayerBackActiviaty.this, mCurDate, _PlayerBackActiviaty.this, 0);
////                dateTimeDialog.show();
//            }
//        });
...
//            // 提示SD卡不可用
//            Utils.showToast(_PlayerBackActiviaty.this, R.string.remoteplayback_SDCard_disable_use);
//            return;
//        }
//
//        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
//            // 提示内存不足
//            Utils.showToast(_PlayerBackActiviaty.this, R.string.remoteplayback_record_fail_for_memory);
//            return;
//        }
//
...
//        Utils.showToast(_PlayerBackActiviaty.this, R.string.remoteplayback_record_fail);
//        if (mIsRecording) {
//            stopRealPlayRecord();
//        }
//    }
...
//            return;
//        }
////        Toast.makeText(_PlayerBackActiviaty.this, getResources().getString(R.string.already_saved_to_volume), Toast.LENGTH_SHORT).show();
//        Toast.makeText(_PlayerBackActiviaty.this, mCurRecordName, Toast.LENGTH_SHORT).show();
//        mCurRecordName = "";
//        // 设置录像按钮为check状态
//        if (!mIsOnStop) {
...
//        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
//            // 提示内存不足
//            Utils.showToast(_PlayerBackActiviaty.this, R.string.remoteplayback_capture_fail_for_memory);
//            return;
//        }
//
...
//
//
//                            MediaScanner mMediaScanner = new MediaScanner(_PlayerBackActiviaty.this);
//                            mMediaScanner.scanFile(path, "jpg");
//                            runOnUiThread(new Runnable() {
//                                @Override
//                                public void run() {
//                                    Toast.makeText(_PlayerBackActiviaty.this, getResources().getString(R.string.already_saved_to_volume)+path, Toast.LENGTH_SHORT).show();
//                                }
//                            });
