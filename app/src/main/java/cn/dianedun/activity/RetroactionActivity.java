...
public class RetroactionActivity extends BaseTitlActivity implements View.OnClickListener {

    @Bind(R.id.tv_annul_gdh)
    TextView tv_annul_gdh;

    @Bind(R.id.tv_retroaction_sqr)
    TextView tv_retroaction_sqr;

    @Bind(R.id.tv_annul_starttime)
    TextView tv_annul_starttime;

    @Bind(R.id.tv_annul_time)
    TextView tv_annul_time;

    @Bind(R.id.tv_retroaction_cause)
    TextView tv_retroaction_cause;
    ...
    @Bind(R.id.rl_retroaction_ok)
    RelativeLayout rl_retroaction_ok;
...
//                    showToast("字数不超过500字");
    ...
    private void setupDialog() {
        ...
        final AlertDialog.Builder listDialog = new AlertDialog.Builder(RetroactionActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rl_retroaction_ok:
                subData();
                break;
            case R.id.img_retroaction_add:
                setupDialog();
                break;
    ...
    private class MyAsync extends AsyncTask<Object, Object, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            diaglog = createLoadingDialog(RetroactionActivity.this, "上传文件中请稍后...");
            diaglog.show();
        }
    ...
    private void showDialog3() {
        ...
        // 设置好参数之后再show
        pop3.showAsDropDown(tv_retroaction_headView);
    }
