...
// */
//
//public class _VideoPlayActivity extends BaseActivity implements NewSpitVideoFragment.OnSpitVideoSelect {
//
//
...
//                    return;
//                }
//                AppManager.getInstance().finishActivity(_VideoPlayActivity.this);
//            }
//        });
//        bindControlView();
//    }
...
//                if (e.getCode() == 2001)
//                    startActivity(new Intent(_VideoPlayActivity.this, LoginActivity.class));
//                mTvTip.setText("暂无设备");
//            }
//
//            @Override
...
//            if (_VideoPlayActivity.this.isFinishing()) {
//                return null;
//            }
//
//            if (!ConnectionDetector.isNetworkAvailable(_VideoPlayActivity.this)) {
...
//                Utils.showToast(_VideoPlayActivity.this, R.string.realplay_play_talkback_fail_ison);
//                break;
//            case ErrorCode.ERROR_TRANSF_DEVICE_PRIVACYON:
//                Utils.showToast(_VideoPlayActivity.this, R.string.realplay_play_talkback_fail_privacy);
//                break;
//            case ErrorCode.ERROR_TRANSF_DEVICE_OFFLINE:
//                Utils.showToast(_VideoPlayActivity.this, R.string.realplay_fail_device_not_exist);
//                break;
...
//                Utils.showToast(_VideoPlayActivity.this, R.string.realplay_play_talkback_request_timeout, errorInfo.errorCode);
//                break;
...
//                Utils.showToast(_VideoPlayActivity.this, R.string.realplay_play_talkback_network_exception, errorInfo.errorCode);
//                break;
//            default:
//                Utils.showToast(_VideoPlayActivity.this, R.string.realplay_play_talkback_fail, errorInfo.errorCode);
//                break;
//        }
...
//        new DateTimeDialogOnlyYMD(_VideoPlayActivity.this, new DateTimeDialogOnlyYMD.MyOnDateSetListener() {
//            @Override
...
//
//                PlayerBackActiviaty.startPlayBackActivity(_VideoPlayActivity.this,mAccessTokenBean.getAccessToken(),url,prefixStr,calendar,
...
//                        }
//                        mStatusLight = true;
////                Toast.makeText(_VideoPlayActivity.this, "正在灯控操作中", Toast.LENGTH_LONG).show();
////                Utils.showToast(_VideoPlayActivity.this,"正在灯控操作中");
//                        showToast(_VideoPlayActivity.this,"正在灯控操作中");
//                        ViseApi api = new ViseApi.Builder(_VideoPlayActivity.this).build();
//                        HashMap hashMap = new HashMap();
//                        hashMap.put("departId",mDepartId);
...
//                                    if (mLightCmd == 1){
//                                        showToast(_VideoPlayActivity.this,"开灯操作成功");
////                                showToast("开灯操作成功");
//                                        mLightCmd = 0;
//                                        mImgLight.setImageResource(R.mipmap.ic_nor_openlight);
//                                    }else{
//                                        showToast(_VideoPlayActivity.this,"关灯操作成功");
////                                showToast("关灯操作成功");
//                                        mLightCmd = 1;
...
//                            return;
//                        if (fragment.getIsRecord()){
//                            final AlertDialog.Builder builder = new AlertDialog.Builder(_VideoPlayActivity.this);
//                            builder.setTitle("提示");
...
//                        }
//
//                        if (AndPermission.hasPermission(_VideoPlayActivity.this, RECORD_AUDIO)){
//                            doTalkBack();
//                        }else{
//                            AndPermission.with(_VideoPlayActivity.this).permission(RECORD_AUDIO).requestCode(1).send();
//                        }
//                    }
//                });
//            }
...
//                            return;
//                        }
//                        if (AndPermission.hasPermission(_VideoPlayActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)){
//                            doRecorde();
//                        }else{
//                            AndPermission.with(_VideoPlayActivity.this).permission(Manifest.permission.WRITE_EXTERNAL_STORAGE).requestCode(0).send();
//                        }
//                    }
//                });
//            }
...
//        if (fragment!=null){
//            if (fragment.getIsRecord()){
//                AlertDialog.Builder builder = new AlertDialog.Builder(_VideoPlayActivity.this);
//                builder.setTitle("提示");
//                builder.setMessage("该操作会中断录像，是否继续？");
//                builder.setPositiveButton("取消", null);
//                builder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
